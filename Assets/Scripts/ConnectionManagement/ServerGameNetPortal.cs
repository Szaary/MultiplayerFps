...
{
    [SerializeField] private int m_MaxPlayers = 4; //max number of players allowed on the server
    ...
    public void OnNetworkReady()
    {
        ...
        else
        {
            ...
            Debug.Log("ServerGameNetPortal: OnNetworkReady. Loading scene: " + Scenes.PlayGround);

            NetworkManager.Singleton.SceneManager.LoadScene(Scenes.PlayGround, LoadSceneMode.Single);
        ...
        NetworkManager.ConnectionApprovalResponse response)
    {
        ...
        if (m_ClientData.Count >= m_MaxPlayers)
        {
    ...
    private static void ApproveConnection(NetworkManager.ConnectionApprovalResponse response)
    {
    ...
    static void AssignPlayerName(ulong clientId, string playerName)
    {
        ...
        //TODO create network status class for players gameobjects
        Debug.Log("Assignined player name: " + playerName);
    }
